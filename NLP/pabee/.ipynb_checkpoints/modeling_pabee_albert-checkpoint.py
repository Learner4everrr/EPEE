...
from src.transformers.models.albert.modeling_albert import (
...
class AlbertModelWithPabeeVe(AlbertModel):
...
class AlbertModelWithPabeeV0(AlbertModel):
    def __init__(self, config):
        super().__init__(config)
...
class AlbertModelWithPabeeV0e(AlbertModel):
    def __init__(self, config):
        super().__init__(config)
...
class AlbertModelWithPabeeV1(AlbertModel):
    """
    ...
    @add_start_docstrings_to_model_forward(ALBERT_START_DOCSTRING)
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
class AlbertModelWithPabeeV2(AlbertModel):
    """
...
class AlbertForSequenceClassificationWithPabee(AlbertPreTrainedModel):
    def __init__(self, config):
        ...
        if config.ee_mechanism == "V0":
            self.albert = AlbertModelWithPabeeV0(config)
        elif config.ee_mechanism == "Ve":
            self.albert = AlbertModelWithPabeeVe(config)
        elif config.ee_mechanism == "V0e":
            self.albert = AlbertModelWithPabeeV0e(config)
        elif config.ee_mechanism == "V1":
            self.albert = AlbertModelWithPabeeV1(config)
        elif config.ee_mechanism == "V2":
            self.albert = AlbertModelWithPabeeV2(config)
        else:
            raise ValueError(
